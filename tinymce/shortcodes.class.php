			...
			foreach( $this->params as $pkey => $param ) {
				...
				switch( $param['type'] ) {
					...
					case 'text' :
						...
						// prepare
						$output  = $row_start;
						$output .= '<input type="text" class="radium-form-text radium-input" name="' . $pkey . '" id="' . $pkey . '" value="' . $param['std'] . '" />' . "\n";
						$output .= $row_end;
					...
					case 'textarea' :
						...
						// prepare
						$output  = $row_start;
						$output .= '<textarea rows="10" cols="30" name="' . $pkey . '" id="' . $pkey . '" class="radium-form-textarea radium-input">' . $param['std'] . '</textarea>' . "\n";
						$output .= $row_end;
					...
					case 'icons' :
						...
						$output .= '<input type="text" class="radium-form-icon radium-input" name="' . $pkey . '" id="' . $pkey . '" value="' . $param['std'] . '" />' . "\n";
